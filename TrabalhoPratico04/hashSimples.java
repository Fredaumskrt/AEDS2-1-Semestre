...
class HashIndiretoLista {
    ...
    public void inserir(classeFilme elemento) {
...
class Celula {
    ...
    Celula(classeFilme elemento) {
        this.elemento = elemento;
        this.prox = null;
    }

    Celula(classeFilme elemento, Celula prox) {
        this.elemento = elemento;
        this.prox = prox;
    }
}
...
class Lista {
    ...
    public boolean pesquisar(String x, int pos) {
        ...
        for (Celula i = primeiro.prox; i != null; i = i.prox) {
            if (i.elemento.getTituloOString().compareTo(x) == 0) {
...
class classeFilme {
    ...
    public void lerTituloeSituacao(String classeFilme) throws Exception {
        ...
        while (!linha.contains("T�tulo original") || !linha.contains("Situa��o")) {
            if (linha.contains("T�tulo original")) {
                this.tituloOriginal = removeTags(linha).split("original")[1].trim(); // PRINTAR POSICAO [1] DO TITULO
                                                                                     // ORIGINAL
            } else if (linha.contains("Situa��o") && linha.contains("strong")) { // se conter
    ...
    public void lerOrcamento(String classeFilme) throws Exception {
        ...
        while (!linha.contains("Or�amento")) {
            linha = br.readLine();
        }
        if (!linha.contains("-")) {
...
public class hashSimples {
    public static void main(String[] args) throws Exception {
        ...
        HashIndiretoLista filme = new HashIndiretoLista(23);
